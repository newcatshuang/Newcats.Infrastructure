/***************************************************************************
 *GUID: 0ed51f6f-b9ed-4725-b09c-ab454c32f0a5
 *CLR Version: 4.0.30319.42000
 *DateCreated：2022-01-09 17:54:31
 *Author: NewcatsHuang
...
public class Repository<TDbContext> : Core.RepositoryBase<TDbContext>, Sqlite.IRepository<TDbContext> where TDbContext : Core.IDbContext
{
    /// <summary>
    /// 数据库上下文
    /// </summary>
    ...
    public override object Insert<TEntity>(TEntity entity, IDbTransaction? transaction = null, int? commandTimeout = null) where TEntity : class
    {
        ...
        string sqlText = $"{RepositoryHelper.GetInsertSqlText(typeof(TEntity))} select last_insert_rowid();";
