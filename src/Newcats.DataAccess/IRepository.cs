...
namespace Newcats.DataAccess
{
    ...
    public interface IRepository<TEntity, TPrimaryKey> where TEntity : class
    {
        ...
        (IEnumerable<TEntity> list, int totalCount) GetPage(int pageIndex, int pageSize, IEnumerable<DbWhere<TEntity>> dbWheres = null, int? commandTimeout = null, params DbOrderBy<TEntity>[] dbOrderBy);
        ...
        (IEnumerable<TEntity> list, int totalCount) GetPage(PageInfo<TEntity> pageInfo, int? commandTimeout = null);
        ...
        /// <param name="commandTimeout">超时时间(单位：秒)</param>
        /// <returns>分页数据</returns>
        Task<(IEnumerable<TEntity> list, int totalCount)> GetPageAsync(PageInfo<TEntity> pageInfo, int? commandTimeout = null);
