...
namespace Newcats.DataAccess.PostgreSql
{
    internal static class NpgsqlUtils
    {
        ...
        internal static string GetFullyQualifiedTableName(string schemaName, string tableName, bool usePostgresQuoting)
        {
        ...
        internal static bool RequiresQuoting(string identifier)
        {
