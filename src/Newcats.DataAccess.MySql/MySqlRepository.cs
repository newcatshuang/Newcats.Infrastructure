...
{
    public class MySqlRepository<TDbContext> : Core.RepositoryBase<TDbContext>, MySql.IRepository<TDbContext> where TDbContext : Core.IDbContext
    {
        ...
        public MySqlRepository(TDbContext context)
        {
            _context = context;
        }
