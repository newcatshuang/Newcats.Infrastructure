# Newcats.DataAccess.Core 数据访问扩组件

[![Net Core](https://img.shields.io/badge/.NET-6-brightgreen.svg?style=flat-square)](https://dotnet.microsoft.com/download)
[![Nuget](https://img.shields.io/nuget/v/Newcats.DataAccess.Core.svg)](https://www.nuget.org/packages/Newcats.DataAccess.Core) [![Newcats.DataAccess.Core](https://img.shields.io/nuget/dt/Newcats.DataAccess.Core.svg)](https://www.nuget.org/packages/Newcats.DataAccess.Core)
